...
### NEW
Execute Master Query from ``~\work\repos\database_scripts\masterquery-2014-03-12.sql``
...
### NEW
Execute Meta Query from ``~\work\repos\database_scripts\metaquery-2014-06-24.sql`` 
...
phenotyper_valdis_2015 <- read.table("data/phenotyper_valdis_2015.txt", sep="\t", header=T, check.names = F)
dim(phenotyper_valdis_2015)
# 254 24

phenotyper_result_joined_valdis <- rbind(phenotyper_result_joined, phenotyper_valdis)
phenotyper_result_joined_valdis_2015 <- rbind(phenotyper_result_joined, phenotyper_valdis, phenotyper_valdis_2015)
dim(phenotyper_result_joined_valdis)
# 4555 24
dim(phenotyper_result_joined_valdis_2015)
# 4809 27
...
write.table(phenotyper_result_joined_valdis_2015, "data/phenotyper_result_joined_valdis_2015.txt", sep="\t")
