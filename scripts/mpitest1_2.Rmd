...
gmd_values <- read.table("data/gmd_values_mpitest1_2.txt", sep="\t", header=TRUE, check.names=FALSE)
dim(gmd_values)
# 114 265 (ALL 114 samples!)

gmd_meta <- read.table("data/gmd_meta_mpitest1_2.txt", sep="\t", header=TRUE)
dim(gmd_meta)
...
pdf("figures/mpitest1_2/PCA_scoresplots_scaling_effect.pdf")
palette(cols_cultivar)
pairs(pca_norm_log10_pareto_rnipals@scores[,1:5], col=factors$cultivar, pch=19, main="pareto scaling")
