...
gmd_meta_jki_field_2012 <- func_get_gmd_metatdata( func_get_experiment_id("JKI_Feld_2012") , 
                                                   phenotyper_result_joined_with_gmd_ids)
#gmd_meta_jki_field_2013 <- func_get_gmd_metatdata( func_get_experiment_id("JKI_Feld_2013") , phenotyper_result_joined_with_gmd_ids)
...
#gmd_meta_breeder_trials <- func_get_gmd_metatdata( func_get_experiment_id("breeder_trials") , phenotyper_result_joined_with_gmd_ids)
...
gmd_meta_mpi_fgh_2015 <- func_get_gmd_metatdata_all( func_get_experiment_id("MPI_FGH_2015"), 
                                                     phenotyper_result_joined_with_gmd_ids)
gmd_meta_mpi_field_2015 <- func_get_gmd_metatdata_all( func_get_experiment_id("MPI_Feld_2015"), 
                                                     phenotyper_result_joined_with_gmd_ids)
gmd_meta_jki_shelter_2015 <- func_get_gmd_metatdata_all( func_get_experiment_id("JKI_Shelter_2015"), 
                                                         phenotyper_result_joined_with_gmd_ids )
```
