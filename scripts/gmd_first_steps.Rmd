...
phenotyper_result_joined_valdis_2015 <- read.table("data/phenotyper_result_joined_valdis_2015.txt", sep="\t", header=TRUE)
...
phenotyper_result_joined_with_gmd_ids <- join(phenotyper_result_joined_valdis_2015, trost_gmd_ids, by="GMD_id")
