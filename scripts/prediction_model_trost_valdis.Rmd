...
# load workspace
# load("prediction_model_trost_valdis_2016-03-07.RData")
```
...
write.table(gmd_meta_model_feld, "output/gmd_meta_model_feld.txt", sep="\t")
...
# the first 1532 lines contain only TROST samples 
...
pairs(norm_values_log10_prep_rnipals@scores, col = gmd_meta_model_sort$treatment)
...
plot(norm_values_log10_prep_rnipals@scores[,1],
     ...
     col = gmd_meta_model_sort$genotype_class, pch=c(17,19)[gmd_meta_model_sort$treatment])
...
# 913 samples (of 997) because 3 cultivars were removed!
...
save.image(paste("prediction_model_trost_valdis_2016-03-07.RData", sep="") )
```
