...
if(length(levels(factors$sample_time))==1){
  res_anova_adj <- func_anova_2fac(values_norm_log10_woOutlier, factors, "treatment", "cultivar", 0.01, analytes_sel_exp_sort$Name)
  } else {
  res_anova_adj <- func_anova_3fac(values_norm_log10_woOutlier, factors, "treatment", "cultivar", "sample_time", 0.01, analytes_sel_exp_sort$Name)
  }
...
func_boxplot_1fac(values_norm_log10_woOutlier, factors, "cultivar", res_anova_adj, cols_cultivar_factor, analytes_sel_exp_sort$Name)
dev.off()
```
